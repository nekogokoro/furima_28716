...
window.addEventListener("DOMContentLoaded", function () {
  ...
  if (path === "/items/new" || path === "/items" || pathRegex.test(path)) {
    ...
    var priceInput = document.getElementById("article-price");
    var addTaxDom = document.getElementById("add-tax-price");
    var profitDom = document.getElementById("profit");
    priceInput.addEventListener("input", function () {
      var inputValue = document.getElementById("article-price").value;
...
/******/ });
//# sourceMappingURL=application-82a01fd76af8035dcbb2.js.map