...
var pay = function pay() {
  Payjp.setPublicKey("pk_test_8ac9b4067095ef02eb74e61a");
  ...
  form.addEventListener("submit", function (e) {
    ...
    var card = {
      ...
      exp_year: "20".concat(formData.get("card-exp_year"))
    };
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  if (path === "/items/new" || path === "/items" || pathRegex.test(path)) {
    ...
    priceInput.addEventListener("input", function () {
      var inputValue = document.getElementById("article_price").value;
...
__webpack_require__(/*! ../item_price */ "./app/javascript/item_price.js"); //require('jquery')
...
/******/ });
//# sourceMappingURL=application-15f5a860ffaab982c1de.js.map