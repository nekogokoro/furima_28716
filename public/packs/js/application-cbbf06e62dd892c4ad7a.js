...
window.addEventListener('click', function () {
  ...
  var addTax = document.getElementById('add-tax-price');
  var profit = document.getElementById('profit');
  item_price.addEventListener('input', function () {
    if (item_price.value.match(/[0-9]+/)) {
      var addTaxPrice = item_price.value * 0.1;
...
__webpack_require__(/*! ../calculator */ "./app/javascript/calculator.js"); // Uncomment to copy all static images under ../images to the output folder and reference
...
/******/ });
//# sourceMappingURL=application-cbbf06e62dd892c4ad7a.js.map