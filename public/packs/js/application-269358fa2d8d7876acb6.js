...
window.addEventListener("DOMContentLoaded", function () {
  ...
  if (path === "/items/new" || path === "/items" || pathRegex.test(path)) {
    ...
    priceInput.addEventListener("input", function () {
      var inputValue = document.getElementById("item-price").value;
...
__webpack_require__(/*! ../item_price */ "./app/javascript/item_price.js"); // Uncomment to copy all static images under ../images to the output folder and reference
...
/******/ });
//# sourceMappingURL=application-269358fa2d8d7876acb6.js.map